...
class DMRFrame(ctk.CTkScrollableFrame):
    def __init__(self, frame_controller, parent, data):
        super().__init__(master=parent, fg_color=frame_controller.page_controller.fg_colors['grey'], label_text='DMR')
...
class POCFrame(ctk.CTkScrollableFrame):
    def __init__(self, frame_controller, parent, data):
        super().__init__(master=parent, fg_color=frame_controller.page_controller.fg_colors['grey'], label_text='POC')
        self.pack(expand=True, side='left', fill='both', padx=5, pady=10)
        row, col = 0, 0
        self.columnconfigure(0, weight=1), self.columnconfigure(1, weight=1)
        for i, model in enumerate(data.values.flatten()):
...
class AccessoriesFrame(ctk.CTkScrollableFrame):
    def __init__(self, frame_controller, parent, data):
        super().__init__(master=parent, fg_color=frame_controller.page_controller.fg_colors['grey'], label_text='Accessories')
        self.pack(expand=True, side='left', fill='both', padx=5, pady=10)
        row, col = 0, 0
        self.columnconfigure(0, weight=1), self.columnconfigure(1, weight=1)
        for i, model in enumerate(data.values.flatten()):
...
class PartsFrame(ctk.CTkScrollableFrame):
    def __init__(self, frame_controller, parent, data):
        super().__init__(master=parent, fg_color=frame_controller.page_controller.fg_colors['grey'], label_text='Parts')
        self.pack(expand=True, side='left', fill='both', padx=5, pady=10)
        row, col = 0, 0
        self.columnconfigure(0, weight=1), self.columnconfigure(1, weight=1)
        for i, model in enumerate(data.values.flatten()):
...
class OthersFrame(ctk.CTkScrollableFrame):
    def __init__(self, frame_controller, parent, data):
        super().__init__(master=parent, fg_color=frame_controller.page_controller.fg_colors['grey'], label_text='Others')
        self.pack(expand=True, side='left', fill='both', padx=5, pady=10)
        row, col = 0, 0
        self.columnconfigure(0, weight=1), self.columnconfigure(1, weight=1)
        for i, model in enumerate(data.values.flatten()):
